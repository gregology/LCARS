    ...
    {type:'wrapper', version:'column', id:'wpr_mainView', flex:'v', flexC:'h', children:[
        ...
        {type:'wrapper', class:'main', flex:'h', flexC:'v', children:[
            ...
            {type:'wrapper', version:'column', flex:'v', children:[
                {type:'elbow', version:'top-left', color:"bg-green-3", label:SHIP_NAME, class:'step-two'},
                {type:'button', color:LCARS.colorGen(uiColors), id:'magheading', label:'Mag Heading'},
                {type:'button', color:LCARS.colorGen(uiColors), id:'courseoverground', label:'Course over Ground'},
                {type:'button', color:LCARS.colorGen(uiColors), label:''},
								{type:'button', color:LCARS.colorGen(uiColors), label:''},
			...
			{type:'column', flexC:'h', flex:'v', children:[
				...
				{type:'wrapper', class:'content', flexC:'v', style:'overflow:auto;margin-top:-30px;', children:[
					...
					{type:'complexButton', text:'--', id:'currentwindspeed', label:'Current Speed in Knots', template:LCARS.templates.sdk.buttons.complexText.typeG, colors: ["bg-blue-1", "bg-blue-1", "bg-blue-1"]},
					...
					{type:'complexButton', text:'---', id:'currentdepth', label:'Current Depth in Feet', template:LCARS.templates.sdk.buttons.complexText.typeG, colors: ["bg-blue-2", "bg-blue-2", "bg-blue-2"]},
