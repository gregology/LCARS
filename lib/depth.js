class Depth {
  ...
  drawGraph() {
    ...
    var averageDepth = this.readings[this.latestKey() - 8]; // create function to get avearge of last 8 elements
    var self = this;
    this.graphElements.forEach(function(element, idx) {
      var reading = self.readings[latestKey - idx];
      if (typeof reading != 'undefined') {
        element.style = verticalBarStyle(((averageDepth - reading) * 50) + 50);
  ...
  setNormal() {
    ...
    this.elementButton.dataset.label = CURRENT_DEPTH_IN_FEET;
  }
